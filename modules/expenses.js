...
function applyStrictReconciliationIdentityPolicy(s){
  ...
  Object.values(s.bankReconciliationDrafts||{}).forEach(draft=>{
    ...
    updatedDrafts.push({draftId:draft.id,account:draft.account,nature:normalizedNature(draft.nature),previousPolicy,matchingPolicy:draft.matchingPolicy,removedAutomaticMatches,preservedResolutionCount:Object.keys(draft.resolutions||{}).length});
