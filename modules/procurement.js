...
const AI_IMAGE_SPECS = [
  ...
  { type: 'front',  label: 'Product front', aspect: '4:5',
    prompt: 'Create a BRAND-NEW professional e-commerce ghost-mannequin packshot of this garment. This is NOT a copy task — do NOT return, crop, filter, recolour or re-frame the reference photo; re-photograph the garment completely from scratch as a fresh studio image. Keep only the garment\'s DESIGN faithful — the same colour, print, graphics, text, cut, length and proportions — but RE-SHOOT it: present the FRONT of the garment worn on an invisible (ghost) mannequin so it holds a clean, filled-out 3D shape, smooth and wrinkle-free, neatly steamed and shaped as a premium catalogue product. Completely REMOVE everything in the reference that is not this single garment — any background, table, floor, surface, hanger, visible mannequin, hands, packaging, plastic wrap, paper, tags, stickers, price labels, pins, clips, accessories, other clothes or objects nearby must NOT appear. Do NOT copy stray marks, creases, folds, shadows or clutter from the reference. Center the garment on a seamless pure-white studio background, even soft lighting, sharp product detail, no human model, no props, no visible hanger, no text or watermark. Do NOT show any inner neck label, brand tag, size tag or care label — the collar/neckline must be clean. Show a SINGLE garment fully in frame — no duplicated or repeated copies, no collage, no second view. IGNORE the reference photo\'s own edges, corners, border, vignette and background colour; do NOT reproduce any coloured or dark rectangle, rounded corner, drop shadow or padding around it. The pure-white background must fill the ENTIRE frame and bleed to ALL FOUR CORNERS — absolutely no black bars, letterboxing, borders, rounded edges, vignette or leftover colour carried over from the source photo.' },
