...
const ROLES = [
  ...
  { id: 'model_calendar', label: 'Model Calendar (bookings and packages; no expenses)' },
  { id: 'samast_accounting', label: 'Samast Accounting' },
  { id: 'personal_claimant', label: 'Personal Expense Submitter (Owner approval only)' },
